...
### Geolocation manager configuration
...
![Chronogram 01](./images/media/geoloc-1.png)

![Chronogram 02](./images/media/geoloc-2.png)

![Chronogram 03](./images/media/geoloc-3.png)

![Chronogram 04](./images/media/geoloc-4.png)

![Chronogram 05](./images/media/geoloc-5.png)

![Chronogram 06](./images/media/geoloc-6.png)

![Chronogram 07](./images/media/geoloc-7.png)

![Chronogram 08](./images/media/geoloc-8.png)

![Chronogram 09](./images/media/geoloc-9.png)

![Chronogram 10](./images/media/geoloc-10.png)

![Chronogram 11](./images/media/geoloc-11.png)
...
#### Configuration of technology scheduling
...
- The first scheduled technology of the list is always performed even
  ...
  - If the **always done** flag is set and we are in
    multi-technology, the reporting is not done.
...
### Geolocation reporting configuration
